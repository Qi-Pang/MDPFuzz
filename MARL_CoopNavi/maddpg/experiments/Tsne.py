...
X1 = np.load('./results/tsne-crash.npy')
X2 = np.load('./results/tsne-normal.npy')
X3 = np.load('./results/tsne-random.npy')
...
plt.grid(True)
plt.savefig('./results/TSNE_MARL.pdf', transparent=True, bbox_inches='tight')
