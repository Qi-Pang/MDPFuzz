...
# We will use the color palette used in Tango Desktop Project
# (Each color is indexed depending on brightness level)
...
class ModuleWorld(object):
    ...
    def _render_vehicles(self, surface, list_v, world_to_pixel):
        ...
        for v in list_v:
            ...
            corners = [world_to_pixel(p) for p in corners]
            pygame.draw.lines(
                surface, color, False, corners, int(math.ceil(4.0 * self.map_image.scale))
            )
