...
# HACK: original all 0
_add("FullTown02-v1", n_vehicles=100, n_pedestrians=0, disable_two_wheels=True, weathers=WEATHER_1)
_add("StraightTown02-v1", n_vehicles=100, disable_two_wheels=True, weathers=WEATHER_1)
_add("TurnTown02-v1", n_vehicles=100, disable_two_wheels=True, weathers=WEATHER_1)
...
_aliases = {
    ...
    "ntown1p": ["NoCrashTown01-v7", "NoCrashTown01-v8", "NoCrashTown01-v9"],
    "ntown2p": ["NoCrashTown02-v7", "NoCrashTown02-v8", "NoCrashTown02-v9"],
...
def make_suite(suite_name, port=2000, planner="new", client=None, crop_sky=False):
